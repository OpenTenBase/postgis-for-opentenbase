...
\cd :scriptdir
\i legacy.sql
-- \i /data/home/kbzhang/OpenTenBase/contrib/postgis-3.2.1/regress/00-regress-install/share/contrib/postgis/legacy.sql
...
alter function find_srid  pushdown;
...
alter function find_srid  NOT pushdown;
